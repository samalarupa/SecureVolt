...
export default function AddContent() {
  ...
  const handleSubmit = async () => {
    const noteForm = new URLSearchParams({ key, content: note });
    await fetch("https://securevolt.webhostdevs.com/backend/add_note.php", {
      method: "POST",
      body: noteForm
    });
    ...
    if (files?.length) {
      ...
      await fetch("https://securevolt.webhostdevs.com/backend/upload.php", {
        method: "POST",
        body: formData
      });
    }
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="bg-[rgba(5,25,55,0.7)] p-8 rounded-sm border-l" style={{ borderColor: colors.secondary }}>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 bg-transparent border rounded-sm focus:outline-none focus:border-[#D4AF37] mt-2 text-sm"
                    style={{ borderColor: 'rgba(212, 175, 55, 0.3)', color: colors.white }}
                  />
                </div>
                <motion.div
